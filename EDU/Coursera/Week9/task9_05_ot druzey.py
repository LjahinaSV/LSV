# Фрагмент с вектором свободных членов
...
def determinator(M):
    if M.size()[0] == 2:
        ...
        return \
            M.Mtx[0][0] * M.Mtx[1][1] * M.Mtx[2][2] \
            + M.Mtx[2][0] * M.Mtx[0][1] * M.Mtx[1][2] \
            + M.Mtx[1][0] * M.Mtx[2][1] * M.Mtx[0][2] \
            - M.Mtx[2][0] * M.Mtx[1][1] * M.Mtx[0][2] \
            - M.Mtx[0][0] * M.Mtx[2][1] * M.Mtx[1][2] \
            - M.Mtx[1][0] * M.Mtx[0][1] * M.Mtx[2][2]
    else:
