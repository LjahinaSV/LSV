...
def start(message: telebot.types.Message):
    text = 'Привет! Я Бот - Конвертер валют.' \
           '\nМоя система команд: /start, /help, /values и команда для конвертации.' \
           '\n/start  - начало работы и вывод СКИ' \
           '\n/help   - напоминает, что я могу' \
           '\n/values - показывает список доступных валют' \
           '\nКоманда для конвертации вводится так:\n <имя валюты>  ' \
